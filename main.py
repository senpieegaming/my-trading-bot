...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
  ...
  # SIGNAL GENERATOR
    ...
    ha_closes, live_price, rsi_val, macd_status = (
        await fetch_deriv_live_data(pair)
    )
    ...
    if is_buy_signal:
      ...
      ha_pattern = random.choice(BEARISH_PATTERNS)
